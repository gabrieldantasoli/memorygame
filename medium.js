...
let getItem = () => JSON.parse(localStorage.getItem('MEDIUM_RANKING')) ?? [{"name": "","points": 0},{"name": "","points": 0},{"name": "","points": 0}];
let setItem = (data) => localStorage.setItem('MEDIUM_RANKING',JSON.stringify(data));
...
let boxes = document.querySelectorAll('#mode2 div');
let can = false;
let x = 0;
let xx = 0;
let ponts = 0;
...
document.getElementById('mode2').addEventListener('click',game);